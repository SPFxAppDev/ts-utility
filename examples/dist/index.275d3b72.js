...
})({"8mSrt":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "6b890e94275d3b72";
"use strict";
...
},{}],"2DXzN":[function(require,module,exports) {
...
class ApiClient {
    ...
    async getAsJson(url, options) {
        ...
        const [data, error] = await asyncFn(ApiClient.sendRequestResultAsJson, url, options);
        if (error) throw error;
        return data;
    }
    ...
    async postAsJson(url, bodyData, options) {
        options = options || {};
        if (bodyData) options.body = JSON.stringify(bodyData);
        options = {
            ...this.defaultPOSTOptions,
    ...
    static async sendRequestResultAsJson(url, options) {
        const [response, error] = await asyncFn(ApiClient.sendRequest, url, options);
        if (error) throw error;
    ...
    static async sendRequest(url, options) {
        const [response, error] = await asyncFn(fetch, url, options);
        if (error) {
            Logger.error({
...
},{}]},["8mSrt","2DXzN"], "2DXzN", "parcelRequirebc7a")

//# sourceMappingURL=index.275d3b72.js.map
