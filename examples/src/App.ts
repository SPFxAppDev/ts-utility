...
class ArrayApp {
  ...
  private firstOrDefaultExamples(): void {
    ...
    const spfxItem: ISimpleItem | null = myArr.FirstOrDefault((i) =>
      i.name.Equals('spfx')
    );
    ...
    const defaultItem: ISimpleItem | null = myArr.FirstOrDefault(
      (i) => i.name.Equals('404'),
      {
        id: randomString(),
    ...
    const defaultNullItem: ISimpleItem | null = myArr.FirstOrDefault((i) =>
      i.name.Equals('404')
    );
  ...
  private whereExamples(): void {
    ...
    const allItemsWhereSequenceGt1: ISimpleItem[] = myArr.Where(
      (i) => i.sequence > 1
    );

    console.log(allItemsWhereSequenceGt1);

    const notFoundItems: ISimpleItem[] = myArr.Where((i) =>
      i.name.Equals('404')
    );
  ...
  private orderByExamples(): void {
    ...
    const allItemsOrderedBySequence: ISimpleItem[] = myArr1.OrderBy(
      (i) => i.sequence
    );
  ...
  private orderByDescendingExamples(): void {
    ...
    const allItemsOrderedBySequenceDescending: ISimpleItem[] =
      myArr1.OrderByDescending((i) => i.sequence);

    console.log(allItemsOrderedBySequenceDescending);

    const allItemsOrderedByNameDescending: ISimpleItem[] =
      myArr2.OrderByDescending((i) => i.name);
  ...
  private orderByMultipleExamples(): void {
    ...
    const allItemsOrderedByNameAndThenSequence: ISimpleItem[] =
      myArr1.OrderByMultiple([(item) => item.name, (item) => item.sequence]);
  ...
  private orderByMultipleDescendingExamples(): void {
    ...
    const allItemsOrderedByNameAndThenSequenceDescending: ISimpleItem[] =
      myArr1.OrderByMultipleDescending([
        (item) => item.name,
        (item) => item.sequence,
      ]);
  ...
  private containsExamples(): void {
    ...
    const containsSpfxItem: boolean = myArr.Contains((i) =>
      i.name.Equals('spfx')
    );

    console.log(containsSpfxItem);

    const contains404Item: boolean = myArr.Contains((i) =>
      i.name.Equals('404')
    );

    console.log(contains404Item);

    const multipleConditions: boolean = myArr.Contains(
      (i) => i.name.Equals('404') || i.name.Equals('spfx')
    );

    console.log(multipleConditions);

    const emptyArrayContains: boolean = [].Contains(
      (i) => (i as any).name.Equals('404') || (i as any).name.Equals('spfx')
    );
  ...
  private countExamples(): void {
    ...
    const totalAppOrDevItems: number = myArr.Count(
      (i) => i.name.Equals('app') || i.name.Equals('dEv')
    );

    console.log(totalAppOrDevItems);

    const emptyArrayCount: number = [].Count(
      (i) => (i as any).name.Equals('404') || (i as any).name.Equals('spfx')
    );
  ...
  private lastOrDefaultExamples(): void {
    ...
    const spfxItem: ISimpleItem | null = myArr.LastOrDefault((i) =>
      i.name.Equals('spfx')
    );
    ...
    const defaultItem: ISimpleItem | null = myArr.LastOrDefault(
      (i) => i.name.Equals('404'),
      {
        id: randomString(),
        name: 'This is item is the default item, because the searched item was not found',
    ...
    const defaultNullItem: ISimpleItem | null = myArr.LastOrDefault((i) =>
      i.name.Equals('404')
    );

    console.log(defaultNullItem);

    const emptyArrCheck: ISimpleItem | null = [].LastOrDefault((i) =>
      (i as any).name.Equals('404')
    );
...
class StringsApp {
  ...
  private startsWithExamples(): void {
    console.log(
      `${this.testString}.StartsWith('hello') ==> `,
      this.testString.StartsWith('hello')
    );
    console.log(
      `${this.testString}.StartsWith('hello', false) ==> `,
      this.testString.StartsWith('hello', false)
    );
    console.log(
      `${this.testString}.StartsWith('@spfxappdev') ==> `,
      this.testString.StartsWith('@spfxappdev')
    );
  }
  ...
  private endsWithExamples(): void {
    console.log(
      `${this.testString}.EndsWith('@SPFxAppDev/Utility') ==> `,
      this.testString.EndsWith('@SPFxAppDev/Utility')
    );
    console.log(
      `${this.testString}.EndsWith('@SPFxAppDev/Utility', false) ==> `,
      this.testString.EndsWith('@SPFxAppDev/Utility', false)
    );
    console.log(
      `${this.testString}.EndsWith('@spfxappdev') ==> `,
      this.testString.EndsWith('@spfxappdev')
    );
  }
  ...
  private containsExamples(): void {
    console.log(
      `${this.testString}.Contains('@SPFxAppDev/Utility') ==> `,
      this.testString.Contains('@SPFxAppDev/Utility')
    );
    console.log(
      `${this.testString}.Contains('@SPFxAppDev/Utility', false) ==> `,
      this.testString.Contains('@SPFxAppDev/Utility', false)
    );
    console.log(
      `${this.testString}.Contains('404') ==> `,
      this.testString.Contains('404')
    );
  }
  ...
  private indexOfExamples(): void {
    console.log(
      `${this.testString}.IndexOf('@SPFxAppDev/Utility') ==> `,
      this.testString.IndexOf('@SPFxAppDev/Utility')
    );
    console.log(
      `${this.testString}.IndexOf('@SPFxAppDev/Utility', false) ==> `,
      this.testString.IndexOf('@SPFxAppDev/Utility', false)
    );
    console.log(
      `${this.testString}.IndexOf('404') ==> `,
      this.testString.IndexOf('404')
    );
  }
  ...
  private insertExamples(): void {
    console.log(
      `${this.testString}.Insert(5, " from") ==> `,
      this.testString.Insert(5, ' from')
    );
    console.log(
      `${this.testString}.Insert(255, " insert to end") ==> `,
      this.testString.Insert(255, ' insert to end')
    );
  }
  ...
  private equalsExamples(): void {
    console.log(
      `${this.testString}.Equals('HeLlO @SPFxAppDev/UTILITY') ==> `,
      this.testString.Equals('HeLlO @SPFxAppDev/UTILITY')
    );
    console.log(
      `${this.testString}.Equals('HeLlO @SPFxAppDev/UTILITY', false) ==> `,
      this.testString.Equals('HeLlO @SPFxAppDev/UTILITY', false)
    );
    console.log(
      `${this.testString}.Equals('404') ==> `,
      this.testString.Equals('404')
    );
  }
  ...
  private replaceAllExamples(): void {
    console.log(
      `"Helloo Woorld, welcoome too string extensioons".ReplaceAll() ==> `,
      'Helloo Woorld, welcoome too string extensioons'.ReplaceAll('oo', 'o')
    ); //Hello World, welcome to string extensions
    console.log(`"".IsEmpty() ==> `, ''.IsEmpty());
    console.log(`"     ".IsEmpty() ==> `, '     '.IsEmpty());
  }
}
...
class FunctionsApp {
  ...
  public start(): void {
    console.log(catchFn<any>((this as any).testThrow));
  ...
  @log()
  private async asyncFnExamples(): Promise<void> {
    const [result, error] = await asyncFn(this.parameterlessPromiseFunc);
    ...
    const [result2, error2] = await asyncFn(this.dummyPromise, true, 2000);
    ...
    const [result3, error3] = await asyncFn(this.dummyPromise, false, 2000);
    console.log('result3', result3, error3);

    //With "this" binding
    const [result4, error4] = await asyncFn(
      this.dummyPromise.bind(this),
      true,
      2000
    );
  ...
  private cssClassesExamples(): void {
    console.log(
      `cssClasses('spfx-app-dev', 'theme') ==> `,
      cssClasses('spfx-app-dev', 'theme')
    );
    console.log(
      `cssClasses('spfx-app-dev', { theme: false }) ==> `,
      cssClasses('spfx-app-dev', { theme: false })
    );
    console.log(
      `cssClasses('spfx-app-dev', ['theme', { active: true, item: false }, null, false, undefined, 0, 1, 'container']) ==> `,
      cssClasses('spfx-app-dev', [
        'theme',
        { active: true, item: false },
        null,
        false,
        undefined,
        0,
  ...
  private getDeepOrDefaultExamples(): void {
    ...
    console.log(
      myObj,
      `getDeepOrDefault(myObj, "My.nested.property") ==> `,
      getDeepOrDefault(myObj, 'My.nested.property')
    );

    console.log(
      myObj,
      `ARRAY: getDeepOrDefault(myObj, "items.2") ==> `,
      getDeepOrDefault(myObj, 'items.2')
    );

    const arr: ISimpleItem[] = getDeepOrDefault<ISimpleItem[]>(myObj, 'items');
    console.log(
      myObj,
      `TypeSafe: getDeepOrDefault<ISimpleItem[]>(myObj, "items") ==> `,
      arr
    );

    console.log(
      myObj,
      `Default: getDeepOrDefault(myObj, "404", "this string is returend as default, because 404 does not exist in myObj") ==> `,
      getDeepOrDefault(
        myObj,
        '404',
        'this string is returend as default, because 404 does not exist in myObj'
      )
    );
  }
  ...
  private getUrlParameterExamples(): void {
    console.log(
      `getUrlParameter("from-window-location") ==> `,
      getUrlParameter('from-window-location')
    );
    console.log(
      `getUrlParameter("from-passed-url", 'http://localhost:1234/?from-passed-url=hello') ==> `,
      getUrlParameter(
        'from-passed-url',
        'http://localhost:1234/?from-passed-url=hello'
      )
    );
    console.log(
      `getUrlParameter("anotherparam", 'http://localhost:1234/?from-passed-url=hello&anotherparam=2') ==> `,
      getUrlParameter(
        'anotherparam',
        'http://localhost:1234/?from-passed-url=hello&anotherparam=2'
      )
    );
  }
  ...
  private isNullOrEmptyExamples(): void {
    console.log(
      `isNullOrEmpty("this is a string") ==> `,
      isNullOrEmpty('this is a string')
    );
  ...
  private issetDeepExamples(): void {
    ...
    console.log(
      myObj,
      `issetDeep(myObj, "My.nested.property") ==> `,
      issetDeep(myObj, 'My.nested.property')
    );

    console.log(
      myObj,
      `ARRAY: issetDeep(myObj, "items.2") ==> `,
      issetDeep(myObj, 'items.2')
    );

    console.log(
      myObj,
      `Not set: issetDeep(myObj, "404") ==> `,
      issetDeep(myObj, '404')
    );
  }
  ...
  private isValidEmailExamples(): void {
    console.log(
      `isValidEmail('seryoga@spfx-app.dev') ==> `,
      isValidEmail('seryoga@spfx-app.dev')
    );
    console.log(
      `isValidEmail('spfx-app.dev') ==> `,
      isValidEmail('spfx-app.dev')
    );
  ...
  private async promiseQueueExamples(): Promise<void> {
    const promise1 = toParameterlessPromiseQueueFunc(
      this.dummyPromise,
      true,
      10000
    );
    const promise2 = this.parameterlessPromiseFunc;
    const promise3 = toParameterlessPromiseQueueFunc(
      this.dummyPromise,
      false,
      2000
    );
    const promise4 = toParameterlessPromiseQueueFunc(
      this.dummyPromise,
      true,
      600
    );
    ...
    const onSuccessFunc = (result: string, index: number) => {
      console.log(
        `The Promise with index ${index} successfully executed. Result is:`,
        result
      );
    };
    ...
    const onSuccessFuncPromise = (
      result: string,
      index: number
    ): Promise<void> => {
      console.log(
        'onSuccessFuncPromise START, wait 2s before execute next promise queue'
      );
    ...
    const onErrorFuncPromise = (
      error: string,
      index: number
    ): Promise<void> => {
      console.log(
        'onErrorFuncPromise START, wait 2s before execute next promise queue'
      );
      return new Promise<void>((resolve, reject) => {
        setTimeout(() => {
          console.error(
            `The Promise with index ${index} failed. Error is:`,
            error
          );
          return reject();
        }, 2000);
  ...
  private randomStringExamples(): void {
    ...
    console.log(
      `randomString(6, 'abcdef0123456789') ==> `,
      randomString(6, 'abcdef0123456789')
    );
  }
  ...
  private replaceNonAlphanumericExamples(): void {
    console.log(
      `replaceNonAlphanumeric('This is a text with non alphanumberic and not underscore characters: 1234567890ß!"§$%&/()=?+#____<---->') ==> `,
      replaceNonAlphanumeric(
        'This is a text with non alphanumberic and not underscore characters: 1234567890ß!"§$%&/()=?+#____<---->'
      )
    );
    console.log(
      `replaceNonAlphanumeric('This is a text with non alphanumberic and not underscore characters: öäü1234567890ß!"§$%&/()=?+#____<---->', '*') ==> `,
      replaceNonAlphanumeric(
        'This is a text with non alphanumberic and not underscore characters: öäü1234567890ß!"§$%&/()=?+#____<---->',
        '*'
      )
    );
    console.log(
  ...
  private stripHTMLExamples(): void {
    console.log(
      "stripHTML(`<div class='abc'>Hello <strong>spfxappdev</strong></div>) ==> ",
      stripHTML(`<div class="abc">Hello <strong>spfxappdev</strong></div>`)
    );
    console.log(
  ...
  private replaceTplExample(): void {
    console.log(
      replaceTpl(
        'Hello {UserName}. Welcome {UserName}, this placeholder is not available: {SPFxAppDev}',
        { UserName: 'SPFxAppDev' }
      )
    );
    ...
    console.log(
      replaceTpl(
        'Hello {404}',
        { User: { FirstName: 'SPFxApp', LastName: 'Dev' } },
        ''
      )
    );
    //Hello
  ...
  private removeAllUrlParametersExample(): void {
    console.log(
      removeAllParametersFromUrl(
        'https://spfx-app.dev#firstAnchor#secondAnchor'
      )
    );
    ...
    console.log(
      removeAllParametersFromUrl(
        'https://spfx-app.dev/path1/path2?param1=1&param2=2#firstAnchor#secondAnchor'
      )
    );
    //https://spfx-app.dev/path1/path2

    console.log(
      removeAllParametersFromUrl('https://spfx-app.dev/#/routedpath')
    );
    //https://spfx-app.dev/
  }
  ...
  private wokdaysExample(): void {
    ...
    console.log(
      countWorkdays(new Date(2022, 11, 1), undefined, undefined, undefined, [
        new Date(2022, 11, 24),
        new Date(2022, 11, 25),
        new Date(2022, 11, 26),
        new Date(2022, 11, 31),
  ...
  private firstAndLastDateExample(): void {
    ...
    console.log(
      'First date of 15 February 2022 is: ',
      firstDayOfMonth(new Date(2022, 1, 15))
    ); //Tue Feb 01 2022
    console.log(
      'Last date of 15 February 2022 is: ',
      lastDayOfMonth(new Date(2022, 1, 15))
    ); //Mon Feb 28 2022
  }
  ...
  private firstAndLastWeekDateExample(): void {
    ...
    console.log(
      'First date of week of 15 February 2022 is: ',
      firstDayOfWeek(new Date(2022, 1, 15))
    ); //Mon Feb 14 2022
    console.log(
      'Last date of week of 15 February 2022 is: ',
      lastDayOfWeek(new Date(2022, 1, 15))
    ); //Sun Feb 20 2022
    console.log(
      'First date of current week by starting with Sunday is: ',
      firstDayOfWeek(null, Weekday.Sunday)
    ); //Sun Nov 13 2022
    console.log(
      'Last date of current week by starting with Sunday is: ',
      lastDayOfWeek(null, Weekday.Sunday)
    ); //Sat Nov 19 2022
  }
  ...
  private weekNumberExample(): void {
    ...
    console.log(
      '15 February 2022 week number: ',
      weekNumber(new Date(2022, 1, 15))
    ); //2022 Feb 15 ==> 7
    console.log(
      '30 December 2019 week number: ',
      weekNumber(new Date(2019, 11, 30))
    ); //2019 Dec 30 (special case) ==> 1
  }
...
class EventExample extends EventListenerBase {
  public Execute(
    name: string,
    lastEventResult: IEventListenerResult,
    ...args: any[]
  ): IEventListenerResult {
